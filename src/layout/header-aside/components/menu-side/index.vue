...
export default {
  ...
  methods: {
    ...
    controlWidth () {
      var pls = 150 - parseInt(jQuery('.el-submenu__title').css('padding-left')) + 'px'
      var pli = 150 - parseInt(jQuery('.el-menu-item').css('padding-left')) + 'px'
      jQuery('.el-submenu__title > span').css('width', pls)
      jQuery('.el-menu-item > span').css('width', pli)
    }
  }
}
</script>
